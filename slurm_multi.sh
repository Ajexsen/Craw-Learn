...
cd src
python3 -c "import optuna;optuna.study.delete_study(study_name='crawler-JR-2', storage='sqlite:///example.db')"
python3 -c "import optuna;optuna.study.create_study(study_name='crawler-JR-2', storage='sqlite:///example.db')"
cd ..
